...
import '../../assets/css/loandetails.css'; // Import CSS file for AgricultureFunds component
      ...
      <div className="funds-grid">
        {fundsData.map((fund) => (
          <div className="fund-card" key={fund.id}>
            ...
            <p>{fund.details}</p>
            <Link to="/MYAPP/user/appointment" className="view-details-btn">View Details</Link> {/* Link to appointment page */}
          </div>
        ))}
      </div>
    </div>
