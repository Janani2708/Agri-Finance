...
// Make sure to install emailjs-com using npm or yarn
    ...
    <div className="contact-page">
      ...
      <div className="contact-page-content">
        <div className="contact-info">
          ...
          <p>
            Email: <a href="mailto:info@glammart.com">info@agrocloud.com</a>
          </p>
          <p>Phone: +1 123-456-7890</p>
          <p>Address: 123 ,AgroCloud Finance Company, Chennai</p>
        </div>
